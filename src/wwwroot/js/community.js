(function (ko, $, moment) {
    ...
    var EventSource = function (sourceObj) {
        ...
        var cmLogo = "https://dotnetsocialweb.azurewebsites.net/assets/cm_logo.png";
        var mLogo = "https://dotnetsocialweb.azurewebsites.net/assets/meetup_logo.png";
        var dLogo = "https://dotnetsocialweb.azurewebsites.net/assets/net_logo.png";
    ...
    var ugAggregatorViewModel = {
        ...
        cmBaseUrl: "https://www.communitymegaphone.com",
        meetupBaseUrl: "https://www.meetup.com/",
        ...
        loadEvents: function () {
            var self = this;
            $.ajax({
                //url: "https://dotnetsocial.cloudapp.net/api/meetup",
                url: "/api/meetup",
                method: "GET",
